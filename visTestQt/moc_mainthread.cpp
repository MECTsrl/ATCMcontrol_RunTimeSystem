...
**
** Created: Fri Nov 11 17:03:12 2011
...
static const char qt_meta_stringdata_ComThread[] = {
    "ComThread\0\0Id,status\0switch_led(int,bool)\0"
    "Id,value\0update_lcd(int,float)\0value\0"
    "update_mbrtu(char*)\0"
};
...
// SIGNAL 0
void ComThread::switch_led(int _t1, bool _t2)
{
...
// SIGNAL 1
void ComThread::update_lcd(int _t1, float _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
...
// SIGNAL 2
void ComThread::update_mbrtu(char * _t1)
{
